...
export class IncomeComponent {
  ...
  selectedMonth: any;
  januaryIncomes: any[] = [
    { source: 'Salary', amount: 5000, incestments: '401(k)' },
    { source: 'Freelancing', amount: 1000, incestments: 'Stocks' },
  ];
  februaryIncomes: any[] = [
    { source: 'Salary', amount: 5500, incestments: '401(k)' },
    { source: 'Rental Income', amount: 700, incestments: 'Real Estate' },
  ];
  marchIncomes: any[] = [
    { source: 'Salary', amount: 5200, incestments: '401(k)' },
    { source: 'Freelancing', amount: 1200, incestments: 'Stocks' },
    { source: 'Rental Income', amount: 600, incestments: 'Real Estate' },
  ]
